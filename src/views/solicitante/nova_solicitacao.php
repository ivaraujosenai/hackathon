...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">Nova Solicitação</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
        <form action="../../controllers/solicitacao_controller.php?action=create" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Cargo -->
                <div>
                    <label for="cargo_solicitante" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Cargo</label>
                    <select id="cargo_solicitante" name="cargo_solicitante" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-100" required>
                ...
                <!-- Categoria -->
                <div>
                    <label for="categoria_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Categoria</label>
                    <select id="categoria_id" name="categoria_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-100" required>
                ...
                <!-- Prioridade -->
                <div>
                    <label for="prioridade" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Prioridade</label>
                    <select id="prioridade" name="prioridade" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-100" required>
            ...
            <!-- Upload de Imagem -->
            <div class="mt-6">
                <label for="path_imagem" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Anexar Imagem (Opcional)</label>
